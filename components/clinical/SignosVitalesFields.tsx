...
export default function SignosVitalesFields({ prefix = 'signos_vitales' }: SignosVitalesFieldsProps) {
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-xs font-semibold text-slate-300 uppercase tracking-wider border-b border-slate-700/80 pb-2">
        Signos vitales y somatometría
      </h3>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">Talla (m o cm)</label>
          <input
            {...register(path('talla'))}
            placeholder="ej. 1.70"
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">FC (lpm)</label>
          <input
            {...register(path('fc'))}
            placeholder="ej. 80"
            className="block w-full px-3 py-2 border border-slate-700 rounded-lg bg-slate-800/50 text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 sm:text-sm"
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">FR (rpm)</label>
          <input
            {...register(path('fr'))}
            placeholder="ej. 16"
            className="block w-full px-3 py-2 border border-slate-700 rounded-lg bg-slate-800/50 text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 sm:text-sm"
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">Tensión arterial</label>
          <input
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">Saturación (%)</label>
          <input
